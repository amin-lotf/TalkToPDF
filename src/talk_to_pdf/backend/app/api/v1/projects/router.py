...
from talk_to_pdf.backend.app.api.v1.projects.deps import get_create_project_use_case, get_get_project_use_case, \
    get_list_user_projects_use_case
from talk_to_pdf.backend.app.api.v1.projects.mappers import get_create_project_input_dto, get_get_project_input_dto, \
    get_list_projects_input_dto, projects_dts_to_schema
from talk_to_pdf.backend.app.api.v1.projects.schemas import ProjectResponse, ListProjectsResponse
...
async def get_project(
    ...
    request_dto = get_get_project_input_dto(user.id,UUID(project_id))
